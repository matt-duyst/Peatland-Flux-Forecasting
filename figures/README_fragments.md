...
**The water table coefficient drifts as its supporting range narrows, so three assumptions bracket it: 10 to 30 g C per square meter**

Each marker is one year's emission in grams of carbon per square meter, from relationships fitted on 2009 to 2019. The three lines each assume something different about the water table beyond its fitted range, and agree only where it stays inside. The strip gives the share of each year's months outside that range. Measurement here stopped in 1992 and did not resume until 2007, so eighteen of these twenty years can never be checked. Only 1991 and 1992 were measured, by Shurpali et al. (1993) and Shurpali and Verma (1998). Their totals have not been obtained; this reconstruction predicts 9.29 and 8.49 g C for May to October. The model is expected to read low by about 14%, stated rather than applied because correcting would extrapolate the correction.
